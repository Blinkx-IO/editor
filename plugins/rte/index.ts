...
export default (editor, opts = {}) => {
    ...
    const fontNamesEl = `<select style="height:1.8rem;color:inherit;" class="blink-field blink-field-select">
      ${fontOptionsEl}
    </select>`;
    ...
    options.fonts && options.fonts.fontSize && rte.add('fontSize', {
        icon: `<select style="height:1.8rem;color:inherit;" class="blink-field blink-field-select">
        ...
        result: rte => {
            if (!pk1) pk1 = new Piklor("#foreColor-picker", options.fonts.fontColor ?
                (Array.isArray(options.fonts.fontColor) ? options.fonts.fontColor : null) : null, {
                    open: "span#rte-font-color.blink-rte-action",
                    closeOnBlur: true
                });
        ...
        result: rte => {
            if (!pk2) pk2 = new Piklor("#hilite-picker", options.fonts.hilite ?
                (Array.isArray(options.fonts.hilite) ? options.fonts.hilite : null) : null, {
                    open: "span#rte-font-hilite.blink-rte-action",
                    closeOnBlur: true
                });
