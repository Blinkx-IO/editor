...
import { contentBlock, type ContentBlock } from "@blocks/contentblocks/model";
import { html } from "@utilities/utilities";
...
const linkBlock = {
    name: 'link',
    label: html` <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
